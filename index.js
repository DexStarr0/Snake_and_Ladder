...
function Dice_no(){
    ...
    switch(Dice){
        case 1:{
            Dice_face.style.background="url(img/dice_face/1.png)";
            Dice_face.style.backgroundSize="cover";
            Dice_face.innerText="";
            break;
        }
        case 2:{
            Dice_face.style.background="url(img/dice_face/2.png)";
            Dice_face.style.backgroundSize="cover";
            Dice_face.innerText="";
            break;
        }
        case 3:{
            Dice_face.style.background="url(img/dice_face/3.png)";
            Dice_face.style.backgroundSize="cover";
            Dice_face.innerText="";
            break;
        }
        case 4:{
            Dice_face.style.background="url(img/dice_face/4.png)";
            Dice_face.style.backgroundSize="cover";
            Dice_face.innerText="";
            break;
        }
        case 5:{
            Dice_face.style.background="url(img/dice_face/5.png)";
            Dice_face.style.backgroundSize="cover";
            Dice_face.innerText="";
            break;
        }
