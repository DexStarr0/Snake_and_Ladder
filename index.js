...
let User_name2 = First_name[0].slice(0,1).toUpperCase() + First_name[0].slice(1,User_name.length);
...
if(User_name==""){
    ...
    document.getElementById("Display_User_name").innerText="Hello "+User_name2;
...
if(User_name=="shivam" || User_name=="pawan" || User_name=="utkarsh"){
    document.getElementById("Final_msg").innerText="msg From Ayush : Wahh Beta " +User_name2+ " aa gaye apna gar uta ke kelne ke liye . gandu . loddu . and many more";
}
    ...
    document.getElementById("Final_msg").innerText="msg From Ayush : Wahh " +User_name2+ " BGMI se man bhar gaya kya? Jo snake_ladder kelne aaya h.";
}
else if(User_name=="saurav"){
    document.getElementById("Final_msg").innerText="msg From Ayush : Wahh " +User_name2+ " Bhiaya. BGMI se man bhar gaya kya? Jo snake_ladder kelne aaye hai.";
}
else if(User_name=="venom" || User_name=="amrit"){
    document.getElementById("Final_msg").innerText="msg From Ayush : Wahh " +User_name2+ " BGMI se man bhar gaya kya? Jo snake_ladder kelne aaya h. Waise kaisa laga mera game?";
}
